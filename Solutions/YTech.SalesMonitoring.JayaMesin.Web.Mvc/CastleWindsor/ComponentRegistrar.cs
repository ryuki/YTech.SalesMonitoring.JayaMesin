...
namespace YTech.SalesMonitoring.JayaMesin.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.SalesMonitoring.JayaMesin.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.SalesMonitoring.JayaMesin.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.SalesMonitoring.JayaMesin.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.SalesMonitoring.JayaMesin.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.SalesMonitoring.JayaMesin.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.SalesMonitoring.JayaMesin.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
